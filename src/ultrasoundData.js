...
export const WEEKLY_ULTRASOUND_DATA = {
  "4": {
    ...
    "markers": [
      {
        ...
        "x": "45%",
        "y": "40%",
        "labelTr": "Ekojenik Endometrium",
        "labelEn": "Echogenic Endometrium",
        "descTr": "Bebeğin tutunduğu zengin kan damarlı süngerimsi rahim içi tabakası.",
        "descEn": "Richly vascularized uterine lining supporting blastocyst implantation."
      },
      {
        "id": "site",
        "x": "52%",
        "y": "48%",
        "labelTr": "İmplantasyon Odağı",
        "labelEn": "Implantation Focus",
        "descTr": "Blastosistin rahim duvarına güvenle yerleştiği milimetrik mikro halka.",
        "descEn": "Microscopic nidus where the blastocyst nests securely into uterine tissue."
      }
    ]
  },
  "5": {
    ...
    "markers": [
      {
        ...
        "x": "50%",
        "y": "46%",
        "labelTr": "Gestasyonel Kese (5mm)",
        "labelEn": "Gestational Sac (5mm)",
        "descTr": "Amniyon sıvısıyla dolu ilk anekoik siyah yuvarlak kese alanı.",
        "descEn": "Initial fluid-filled anechoic dark pocket harboring early embryonic cells."
      },
      {
        "id": "ddsign",
        "x": "56%",
        "y": "42%",
        "labelTr": "Çift Decidual Halka",
        "labelEn": "Double Decidual Sign",
        "descTr": "Kesenin etrafındaki iki katmanlı parlak sınır; sağlıklı rahim içi gebeliğin kesin kanıtıdır.",
        "descEn": "Concentric echogenic rings confirming true intrauterine pregnancy."
      }
    ]
  },
  "6": {
    ...
    "markers": [
      {
        ...
        "x": "46%",
        "y": "48%",
        "labelTr": "Yolk Sac (Vitellus Kesesi)",
        "labelEn": "Yolk Sac (Vitelline)",
        "descTr": "Plasenta oluşana dek embriyoya besin ve kan hücresi sağlayan dairesel halka.",
        "descEn": "Nutrient-rich ring nourishing the embryo before placenta maturity."
      },
      {
        "id": "heart",
        "x": "54%",
        "y": "52%",
        "labelTr": "Embriyo & Kalp Titreşimi",
        "labelEn": "Embryo & Cardiac Flicker",
        "descTr": "Dakikada 110-130 kez titreşen ilk hücresel kalp kasılmaları.",
        "descEn": "Initial embryonic silhouette with rhythmic cardiac pulsatile contractions."
      }
    ]
  },
  "7": {
    ...
    "markers": [
      {
        ...
        "x": "42%",
        "y": "42%",
        "labelTr": "Kranial Kutup (Baş)",
        "labelEn": "Cranial Pole (Head)",
        "descTr": "Hızla büyüyen ilkel beyin veziküllerinin oluşturduğu baş çıkıntısı.",
        "descEn": "Early cranial vesicle forming the prominent embryonic head."
      },
      {
        "id": "crl_tail",
        "x": "58%",
        "y": "56%",
        "labelTr": "Kaudal Kutup (Gövde)",
        "labelEn": "Caudal Pole (Rump)",
        "descTr": "Omurga hattının başlangıcı ve kuyruk sokumu referans noktası.",
        "descEn": "Spinal neural tube origin and rump caliper landmark."
      }
    ]
  },
  "8": {
    ...
    "markers": [
      {
        ...
        "x": "42%",
        "y": "36%",
        "labelTr": "Gestasyonel Kese",
        "labelEn": "Gestational Sac",
        "descTr": "Kesenin düzenli oval kenarı ve rahim içi yerleşimi sağlıklı tutunmayı doğrular.",
        "descEn": "Smooth oval contour confirming healthy intrauterine implantation."
      },
      {
        "id": "yolk",
        "x": "55%",
        "y": "48%",
        "labelTr": "Yolk Sac (Vitellus)",
        "labelEn": "Yolk Sac",
        "descTr": "Plasenta devralana kadar embriyonun ilk besin kaynağını sağlayan dairesel kese.",
        "descEn": "Provides primary nutrition to the embryo before the placenta fully forms."
      },
      {
        "id": "pole",
        "x": "49%",
        "y": "58%",
        "labelTr": "Embriyonik Kutup & Kalp",
        "labelEn": "Embryonic Pole & Heart",
        "descTr": "Bebeğin ilk hücresel silüeti ve dakikada 130-150 atan minik kalp atımı.",
        "descEn": "First visible embryonic silhouette with rhythmic 130-150 bpm cardiac flicker."
      }
    ]
  },
  "9": {
    ...
    "markers": [
      {
        ...
        "x": "40%",
        "y": "48%",
        "labelTr": "Kol Tomurcukları",
        "labelEn": "Upper Limb Buds",
        "descTr": "Omuzdan uzayan ve minik kürek şeklinde beliren kollar.",
        "descEn": "Paddle-shaped early forelimbs extending from fetal shoulders."
      },
      {
        "id": "hernia",
        "x": "54%",
        "y": "54%",
        "labelTr": "Fizyolojik Kordon Çıkıntısı",
        "labelEn": "Midgut Herniation",
        "descTr": "Gelişen bağırsakların göbek kordonu tabanındaki tamamen normal geçici konumu.",
        "descEn": "Benign developmental loop of embryonic intestines temporarily in the cord."
      }
    ]
  },
  "10": {
    ...
    "markers": [
      {
        ...
        "x": "38%",
        "y": "36%",
        "labelTr": "Kafatası Kemikleşmesi",
        "labelEn": "Cranial Vault",
        "descTr": "Kafatasını çevreleyen ince parlak kıkırdak-kemikleşme hattı.",
        "descEn": "Thin hyperechoic rim marking early fetal skull bone mineralization."
      },
      {
        "id": "posture",
        "x": "52%",
        "y": "50%",
        "labelTr": "Fleksiyon Duruşu",
        "labelEn": "Flexion Posture",
        "descTr": "Bebeğin anne rahmindeki huzurlu C-şekilli kıvrılma pozisyonu.",
        "descEn": "Characteristic gentle C-shaped fetal spine curve in amniotic fluid."
      }
    ]
  },
  "11": {
    ...
    "markers": [
      {
        ...
        "x": "35%",
        "y": "34%",
        "labelTr": "Yüz Profili & Çene",
        "labelEn": "Facial Profile & Chin",
        "descTr": "Burun ucu, dudak kavsi ve çene hattının kusursuz orantısı.",
        "descEn": "Delicate aesthetic contour of nose, upper lip, and mandibular jaw."
      },
      {
        "id": "abdo",
        "x": "58%",
        "y": "56%",
        "labelTr": "Karın Ön Duvarı",
        "labelEn": "Abdominal Wall",
        "descTr": "Göbeğin tamamen kapanıp bağırsakların karın içine yerleşmesi.",
        "descEn": "Intact ventral wall confirming closure of physiologic umbilical hernia."
      }
    ]
  },
  "12": {
    ...
    "markers": [
      {
        ...
        "x": "38%",
        "y": "32%",
        "labelTr": "Ense Kalınlığı (NT)",
        "labelEn": "Nuchal Translucency (NT)",
        "descTr": "Bebeğin ense arkasındaki sıvı katmanı. 2.5 mm altındaki değerler normal kabul edilir.",
        "descEn": "Fluid pocket behind the fetal neck. Normal range is strictly under 2.5 mm."
      },
      {
        "id": "nasal",
        "x": "32%",
        "y": "28%",
        "labelTr": "Burun Kemiği (NB)",
        "labelEn": "Nasal Bone (NB)",
        "descTr": "Kromozomal taramada burun kemiğinin varlığı ve kıkırdak yapısı pozitif bir belirteçtir.",
        "descEn": "Presence of ossified nasal bone is a key reassuring marker in genetic screening."
      },
      {
        "id": "crl",
        "x": "54%",
        "y": "52%",
        "labelTr": "CRL (Baş-Popo Boyu)",
        "labelEn": "CRL (Crown-Rump Length)",
        "descTr": "Bebeğin başından kuyruk sokumuna net uzunluğu; gebelik yaşının en kesin referansıdır.",
        "descEn": "Exact measurement from crown to rump, setting the definitive gestational due date."
      }
    ]
  },
  "13": {
    ...
    "markers": [
      {
        ...
        "x": "48%",
        "y": "38%",
        "labelTr": "Koroit Pleksus (Kelebek)",
        "labelEn": "Choroid Plexus (Butterfly)",
        "descTr": "Beyin omurilik sıvısı üreten simetrik iki parlak süngerimsi doku.",
        "descEn": "Symmetric echogenic lobes producing protective cerebrospinal fluid."
      },
      {
        "id": "falx",
        "x": "50%",
        "y": "28%",
        "labelTr": "Falks Serebri (Orta Hat)",
        "labelEn": "Falx Cerebri (Midline)",
        "descTr": "Beyni iki eşit yarımküreye bölen düzgün orta çizgi.",
        "descEn": "Straight echogenic midline confirming balanced left and right brain development."
      }
    ]
  },
  "14": {
    ...
    "markers": [
      {
        ...
        "x": "45%",
        "y": "44%",
        "labelTr": "Vertebra Kemikleri",
        "labelEn": "Vertebral Bodies",
        "descTr": "Birbiriyle uyumlu aralıklarla dizilen omur kemikçikleri.",
        "descEn": "Regularly spaced hyperechoic ossification points along spinal column."
      },
      {
        "id": "skin",
        "x": "38%",
        "y": "42%",
        "labelTr": "Kesintisiz Cilt Hattı",
        "labelEn": "Intact Skin Covering",
        "descTr": "Omurgayı örten derinin tam kapalı olduğunu teyit eden pürüzsüz hat.",
        "descEn": "Smooth continuous cutaneous border confirming neural tube integrity."
      }
    ]
  },
  "15": {
    ...
    "markers": [
      {
        ...
        "x": "60%",
        "y": "35%",
        "labelTr": "Amniyon Sıvı Cebi",
        "labelEn": "Amniotic Fluid Pocket",
        "descTr": "Bebeğin kas ve akciğer hareketlerini rahatça çalışabildiği koruyucu sıvı alanı.",
        "descEn": "Deep protective fluid chamber allowing effortless musculoskeletal movement."
      },
      {
        "id": "hands",
        "x": "42%",
        "y": "46%",
        "labelTr": "El & Parmaklar",
        "labelEn": "Hands & Digits",
        "descTr": "Minik parmaklarını açıp kapayan ve yüzüne dokunan eller.",
        "descEn": "Delicate open palm and curled fingers brushing against cheek."
      }
    ]
  },
  "16": {
    ...
    "markers": [
      {
        ...
        "x": "50%",
        "y": "38%",
        "labelTr": "BPD Çapı (Şakaklar Arası)",
        "labelEn": "Biparietal Diameter (BPD)",
        "descTr": "Kafatasının en geniş iki kemiği arasındaki milimetrik çap.",
        "descEn": "Outer-to-inner parietal bone diameter defining gestational progress."
      },
      {
        "id": "csp",
        "x": "50%",
        "y": "46%",
        "labelTr": "Kavitum Septi Pellusidi",
        "labelEn": "Cavum Septi Pellucidi",
        "descTr": "Beyin orta hattında yer alan sağlıklı nörolojik belirteç kutucuğu.",
        "descEn": "Fluid-filled midline box landmark confirming normal brain architecture."
      }
    ]
  },
  "17": {
    ...
    "markers": [
      {
        ...
        "x": "48%",
        "y": "52%",
        "labelTr": "Femur Diyafizi (~25 mm)",
        "labelEn": "Femur Diaphysis (~25mm)",
        "descTr": "Bebeğin bacak boyu ve genetik boy potansiyelinin en güvenilir ölçüsü.",
        "descEn": "Linear hyperechoic shaft of the thigh bone assessing skeletal growth."
      },
      {
        "id": "shadow",
        "x": "48%",
        "y": "64%",
        "labelTr": "Akustik Gölge",
        "labelEn": "Acoustic Shadow",
        "descTr": "Kalsiyumla güçlenen kemiğin ses dalgalarını durdurarak arkasında bıraktığı doğal gölge.",
        "descEn": "Acoustic shadowing confirming rich calcium mineralization in the bone."
      }
    ]
  },
  "18": {
    ...
    "markers": [
      {
        ...
        "x": "42%",
        "y": "48%",
        "labelTr": "Mide Cebi (Sol)",
        "labelEn": "Stomach Bubble (Left)",
        "descTr": "Bebeğin amniyon sıvısını başarıyla yuttuğunu gösteren sıvı dolu kese.",
        "descEn": "Fluid collection confirming patent esophagus and active swallowing."
      },
      {
        "id": "situs",
        "x": "55%",
        "y": "46%",
        "labelTr": "Karaciğer & Portal Ven",
        "labelEn": "Liver & Portal Vein",
        "descTr": "Karın içi organların doğru anatomik pozisyonda yerleştiğinin teyidi.",
        "descEn": "Normal right-sided liver lobe and umbilical venous branching."
      }
    ]
  },
  "19": {
    ...
    "markers": [
      {
        ...
        "labelTr": "Sol Böbrek",
        "labelEn": "Left Kidney",
        "descTr": "Korteks ve medullası net seçilen sağlıklı filtreleme ünitesi.",
        "descEn": "Normal renal parenchyma without pelvicalyceal dilation."
      },
      {
        "id": "kidney_r",
        "x": "58%",
        "y": "50%",
        "labelTr": "Sağ Böbrek",
        "labelEn": "Right Kidney",
        "descTr": "Sağ omurga yanında simetrik yerleşimli böbrek dokusu.",
        "descEn": "Contralateral kidney demonstrating symmetric functional development."
      }
    ]
  },
  "20": {
    ...
    "markers": [
      {
        ...
        "x": "52%",
        "y": "46%",
        "labelTr": "4 Odacıklı Kalp",
        "labelEn": "4-Chamber Heart",
        "descTr": "İki kulakçık ve iki karıncık simetrisi, kapakçık geçişleri ve septum bütünlüğü kontrol edilir.",
        "descEn": "Symmetry of left and right atria and ventricles, valve movement, and intact septum."
      },
      {
        "id": "spine",
        "x": "44%",
        "y": "36%",
        "labelTr": "Omurga & Nöral Tüp",
        "labelEn": "Spine & Neural Tube",
        "descTr": "Boyundan kuyruk sokumuna omurga kemikleri ve üzerini örten cilt hattı kesintisiz incelenir.",
        "descEn": "Continuous skin-covering line over the entire vertebrae ruling out spina bifida."
      },
      {
        "id": "brain",
        "x": "35%",
        "y": "25%",
        "labelTr": "Beyincik & Sisterna Magna",
        "labelEn": "Cerebellum & Cisterna Magna",
        "descTr": "Kafatası simetrisi, beyin yarımküreleri ve ventrikül sıvı genişlikleri ölçülür.",
        "descEn": "Brain hemisphere symmetry and normal fluid ventricles confirming CNS health."
      },
      {
        "id": "kidneys",
        "x": "58%",
        "y": "60%",
        "labelTr": "Böbrekler & Mesane",
        "labelEn": "Kidneys & Bladder",
        "descTr": "Bebeğin amniyon sıvısını yutup böbrekleriyle süzdüğünü gösteren aktif dolum kontrolü.",
        "descEn": "Functional amniotic fluid recycling verified via visible bilateral renal filtration."
      },
      {
        "id": "limbs",
        "x": "66%",
        "y": "72%",
        "labelTr": "Femur & Parmaklar",
        "labelEn": "Femur & Digits",
        "descTr": "Uyluk kemiği (FL) uzunluğu ve el-ayak parmaklarının eksiksiz simetrisi sayılır.",
        "descEn": "Femur length (FL) measurement and verification of all ten fingers and toes."
      }
    ]
  },
  "21": {
    ...
    "markers": [
      {
        ...
        "x": "46%",
        "y": "46%",
        "labelTr": "Aort Kökü (LVOT)",
        "labelEn": "Aortic Root (LVOT)",
        "descTr": "Sol karıncıktan çıkıp vücuda temiz kan pompalayan ana damar kavsi.",
        "descEn": "Aortic valve and ascending aorta emerging seamlessly from the left ventricle."
      },
      {
        "id": "pulmonary",
        "x": "56%",
        "y": "42%",
        "labelTr": "Pulmoner Arter (RVOT)",
        "labelEn": "Pulmonary Trunk (RVOT)",
        "descTr": "Sağ karıncıktan çıkıp aortu çaprazlayan akciğer damar gövdesi.",
        "descEn": "Pulmonary trunk crossing anterior and orthogonal to the aortic root."
      }
    ]
  },
  "22": {
    ...
    "markers": [
      {
        ...
        "x": "48%",
        "y": "45%",
        "labelTr": "Beyincik (Kumbara Görünümü)",
        "labelEn": "Cerebellum (Dumbbell)",
        "descTr": "İki simetrik yarımküresiyle denge ve motor kontrol merkezinin olgunlaşması.",
        "descEn": "Characteristic dumbbell-shaped bilateral cerebellar hemispheres."
      },
      {
        "id": "cisterna",
        "x": "48%",
        "y": "58%",
        "labelTr": "Sisterna Magna (<10 mm)",
        "labelEn": "Cisterna Magna (<10mm)",
        "descTr": "Beyincik arkasındaki koruyucu sıvı cebi; 2-10 mm arası ideal derinliktir.",
        "descEn": "Fluid space behind cerebellum ruling out Chiari malformations."
      }
    ]
  },
  "23": {
    ...
    "markers": [
      {
        ...
        "x": "48%",
        "y": "52%",
        "labelTr": "Kesintisiz Üst Dudak",
        "labelEn": "Intact Upper Lip",
        "descTr": "Dudak hattının pürüzsüz bir yay şeklinde birleştiğinin görsel teyidi.",
        "descEn": "Continuous mucosal line ruling out cleft lip defects."
      },
      {
        "id": "nostrils",
        "x": "48%",
        "y": "44%",
        "labelTr": "Simetrik Burun Delikleri",
        "labelEn": "Bilateral Nostrils",
        "descTr": "Nefes yollarının temel yapısını oluşturan iki simetrik kıkırdak açıklık.",
        "descEn": "Two distinct patent circular nostrils framed by nasal tip."
      }
    ]
  },
  "24": {
    ...
    "markers": [
      {
        ...
        "x": "50%",
        "y": "48%",
        "labelTr": "AC Elips Ölçümü",
        "labelEn": "AC Ellipse Caliper",
        "descTr": "Fetal ağırlık formüllerinin en hassas parametresi olan karın dış hattı.",
        "descEn": "Primary biometric parameter determining fetal nutrition and weight."
      },
      {
        "id": "portal",
        "x": "54%",
        "y": "46%",
        "labelTr": "J-Biçimli Portal Ven",
        "labelEn": "J-Shaped Portal Vein",
        "descTr": "Ölçümün doğru seviyeden yapıldığını kanıtlayan karaciğer damar kavsi.",
        "descEn": "Internal acoustic landmark ensuring exact cross-sectional validity."
      }
    ]
  },
  "25": {
    ...
    "markers": [
      {
        ...
        "x": "42%",
        "y": "60%",
        "labelTr": "Topuk Kemiği (Kalkaneus)",
        "labelEn": "Heel (Calcaneus)",
        "descTr": "Ayak iskeletinin en güçlü kemikleşme noktası.",
        "descEn": "Prominent echogenic ossification point of the heel."
      },
      {
        "id": "toes",
        "x": "58%",
        "y": "40%",
        "labelTr": "5 Ayrı Ayak Parmağı",
        "labelEn": "Five Aligned Toes",
        "descTr": "Başparmaktan küçük parmağa simetrik ve serbestçe hareket eden parmaklar.",
        "descEn": "Distinct digital rays confirming complete digit separation."
      }
    ]
  },
  "26": {
    ...
    "markers": [
      {
        ...
        "x": "42%",
        "y": "45%",
        "labelTr": "Sol Göz Merceği (Lens)",
        "labelEn": "Left Optic Lens",
        "descTr": "Işığa ve karanlığa tepki verecek saydam göz küresi halkası.",
        "descEn": "Circular echogenic border outlining the clear crystalline lens."
      },
      {
        "id": "lens_r",
        "x": "58%",
        "y": "45%",
        "labelTr": "Sağ Göz Merceği (Lens)",
        "labelEn": "Right Optic Lens",
        "descTr": "Simetrik derinlikte konumlanan sağ göz merceği.",
        "descEn": "Symmetrical contralateral orbit confirming normal interpupillary distance."
      }
    ]
  },
  "27": {
    ...
    "markers": [
      {
        ...
        "x": "50%",
        "y": "36%",
        "labelTr": "Plasenta Dokusu (Evre 1)",
        "labelEn": "Placenta (Grade 1)",
        "descTr": "Bebeğe oksijen ve besin taşıyan zengin süngerimsi kılcal damar ağı.",
        "descEn": "Vascular organ transferring maternal nutrients and oxygen to fetus."
      },
      {
        "id": "retro",
        "x": "50%",
        "y": "26%",
        "labelTr": "Retroplasental Alan",
        "labelEn": "Retroplacental Zone",
        "descTr": "Plasentanın rahim kasına sağlıklı tutunduğunu gösteren koyu sıvı şeridi.",
        "descEn": "Hypoechoic vascular clear space ruling out invasive accreta."
      }
    ]
  },
  "28": {
    ...
    "markers": [
      {
        ...
        "x": "36%",
        "y": "28%",
        "labelTr": "Baş Gelişi (Sefalik Duruş)",
        "labelEn": "Cephalic Presentation",
        "descTr": "Bebeğin doğum kanalına doğru baş aşağı duruşu ve pelvise yerleşimi izlenir.",
        "descEn": "Head-down fetal orientation aligned with the birth canal preparing for labor."
      },
      {
        "id": "placenta",
        "x": "68%",
        "y": "38%",
        "labelTr": "Plasenta Derecesi & Konum",
        "labelEn": "Placental Grade & Position",
        "descTr": "Plasentanın doğum yolunu kapatmadığı (previa olmadığı) ve kalsifikasyon olgunluğu.",
        "descEn": "Ensures placenta is positioned safely away from cervix with optimal nutrient transfer."
      },
      {
        "id": "fluid",
        "x": "50%",
        "y": "64%",
        "labelTr": "Amniyon Sıvısı Cebi (AFI)",
        "labelEn": "Amniotic Fluid Index (AFI)",
        "descTr": "Bebeği darbelere karşı koruyan ve akciğer hareketine alan açan sıvı derinliği kontrol edilir.",
        "descEn": "Deepest vertical pocket assessment ensuring rich cushioning and lung training space."
      },
      {
        "id": "doppler",
        "x": "58%",
        "y": "50%",
        "labelTr": "Göbek Kordonu Doppler Akımı",
        "labelEn": "Umbilical Doppler Flow",
        "descTr": "3 damarlı kordonda plasentadan bebeğe akan oksijenli kanın direnç indeksi (S/D) ölçülür.",
        "descEn": "Color Doppler resistance index verifying robust oxygenation through umbilical vessels."
      }
    ]
  },
  "29": {
    ...
    "markers": [
      {
        ...
        "x": "46%",
        "y": "50%",
        "labelTr": "Diyafram Hattı",
        "labelEn": "Diaphragmatic Arc",
        "descTr": "Göğüs ve karın boşluğunu ayıran kubbe şekilli koyu kas çizgisi.",
        "descEn": "Hypoechoic curved muscular barrier moving rhythmically."
      },
      {
        "id": "thorax",
        "x": "46%",
        "y": "40%",
        "labelTr": "Göğüs Kafesi & Akciğerler",
        "labelEn": "Thorax & Lungs",
        "descTr": "Doğum sonrası ilk nefese hazırlanan süngerimsi akciğer dokusu.",
        "descEn": "Echogenic pulmonary tissue preparing for atmospheric respiration."
      }
    ]
  },
  "30": {
    ...
    "markers": [
      {
        ...
        "x": "48%",
        "y": "42%",
        "labelTr": "Umbilikal Ven (Oksijen Taşıyıcı)",
        "labelEn": "Umbilical Vein",
        "descTr": "Plasentadan bebeğe temiz kan getiren geniş lümenli ana damar.",
        "descEn": "Large central vessel carrying oxygenated blood to the fetal heart."
      },
      {
        "id": "arteries",
        "x": "52%",
        "y": "54%",
        "labelTr": "2 Umbilikal Arter",
        "labelEn": "Two Umbilical Arteries",
        "descTr": "Atık kanı plasentaya geri taşıyan iki küçük simetrik damar.",
        "descEn": "Dual coiled arteries returning blood to the placenta."
      }
    ]
  },
  "31": {
    ...
    "markers": [
      {
        ...
        "x": "50%",
        "y": "50%",
        "labelTr": "Dikey Sıvı Cebi (5.4 cm)",
        "labelEn": "Deepest Pocket (5.4cm)",
        "descTr": "Bebeğin böbrek fonksiyonu ve plasenta sağlığını yansıtan mükemmel sıvı derinliği.",
        "descEn": "Clear vertical acoustic column confirming optimal fluid equilibrium."
      }
    ]
  },
  "32": {
    ...
    "markers": [
      {
        ...
        "x": "45%",
        "y": "44%",
        "labelTr": "MCA Damar Yolu",
        "labelEn": "Middle Cerebral Artery",
        "descTr": "Bebeğin beynine giden oksijen miktarını milisaniyelik hassasiyetle gösterir.",
        "descEn": "Cerebral arterial trunk assessing oxygen delivery to fetal brain tissue."
      },
      {
        "id": "willis",
        "x": "52%",
        "y": "46%",
        "labelTr": "Willis Poligonu",
        "labelEn": "Circle of Willis",
        "descTr": "Beyin tabanındaki dairesel koruyucu damar çemberi.",
        "descEn": "Hexagonal vascular anastomotic ring at the base of the fetal cranium."
      }
    ]
  },
  "33": {
    ...
    "markers": [
      {
        ...
        "x": "40%",
        "y": "36%",
        "labelTr": "Dalgalanan Saçlar",
        "labelEn": "Floating Hair Strands",
        "descTr": "Amniyon sıvısında narin bir püskül gibi salınan ilk saç tutamları.",
        "descEn": "Fine echogenic filaments extending from the scalp into amniotic fluid."
      },
      {
        "id": "scalp",
        "x": "48%",
        "y": "44%",
        "labelTr": "Kafa Kemik Hattı",
        "labelEn": "Scalp Soft Tissue",
        "descTr": "Kemik üzerinde kalınlaşan koruyucu yumuşak doku katmanı.",
        "descEn": "Subcutaneous fat cushion protecting the ossified parietal bones."
      }
    ]
  },
  "34": {
    ...
    "markers": [
      {
        ...
        "x": "52%",
        "y": "48%",
        "labelTr": "DFE Epifiz Çekirdeği",
        "labelEn": "DFE Ossification Center",
        "descTr": "Bebeğin gelişim haftasının 34+ olduğunu ve akciğerlerin olgunlaştığını fısıldayan küçük kıkırdak inci.",
        "descEn": "Small discrete bone nodule reliably indicating advanced fetal maturity."
      }
    ]
  },
  "35": {
    ...
    "markers": [
      {
        ...
        "x": "46%",
        "y": "42%",
        "labelTr": "Virgül Kalsifikasyonlar",
        "labelEn": "Comma-like Densities",
        "descTr": "Plasentanın doğuma hazırlanan olgun yapısının doğal ekojenik çizgileri.",
        "descEn": "Physiological echogenic densities characteristic of near-term placenta."
      },
      {
        "id": "plate",
        "x": "52%",
        "y": "32%",
        "labelTr": "Koryonik Plak Girintileri",
        "labelEn": "Chorionic Plate Folds",
        "descTr": "Besin alışverişini son haftalarda en yüksek verimde tutan yüzey katlanmaları.",
        "descEn": "Wavy undulating contour of the fetal placental surface."
      }
    ]
  },
  "36": {
    ...
    "markers": [
      {
        ...
        "x": "45%",
        "y": "35%",
        "labelTr": "Pelvise Yerleşen Baş",
        "labelEn": "Engaged Cranium",
        "descTr": "Bebeğin doğum kanalına hizalanmış baş aşağı güvenli pozisyonu.",
        "descEn": "Well-flexed fetal skull snugly fitted in maternal pelvic brim."
      },
      {
        "id": "cervix",
        "x": "55%",
        "y": "65%",
        "labelTr": "Kapalı Rahim Ağzı (Serviks)",
        "labelEn": "Closed Internal Os",
        "descTr": "Doğum sancıları başlayana kadar bebeği koruyan uzun ve kapalı boyun.",
        "descEn": "Competent long endocervical canal holding firm before labor."
      }
    ]
  },
  "37": {
    ...
    "markers": [
      {
        ...
        "x": "48%",
        "y": "42%",
        "labelTr": "Suboksipitobregmatik Çap",
        "labelEn": "Suboccipitobregmatic",
        "descTr": "Doğumda en küçük çapla kanala girmesini sağlayan çene göğse eğilme açısı.",
        "descEn": "Optimal cranial flexion presenting the smallest circumference for delivery."
      }
    ]
  },
  "38": {
    ...
    "markers": [
      {
        ...
        "x": "44%",
        "y": "46%",
        "labelTr": "Bukkal Yağ Yastığı (Yanak)",
        "labelEn": "Buccal Fat Pad",
        "descTr": "Doğum sonrası anne memesini güçlüce kavramak için biriken yanak yağı.",
        "descEn": "Prominent cheek fat deposit specialized for powerful breastfeeding suction."
      },
      {
        "id": "suck",
        "x": "52%",
        "y": "52%",
        "labelTr": "Aktif Emme Hareketi",
        "labelEn": "Sucking Reflex",
        "descTr": "Dudakların ritmik büzülmesiyle ilk beslenmeye hazır refleks.",
        "descEn": "Pursed lips practicing rhythmic oral feeding coordination."
      }
    ]
  },
  "39": {
    ...
    "markers": [
      {
        ...
        "x": "50%",
        "y": "56%",
        "labelTr": "İç Servikal Ağız (Internal Os)",
        "labelEn": "Internal Cervical Os",
        "descTr": "Kasılmalarla birlikte açılmaya başlayacak olan rahim kapısı.",
        "descEn": "Cervical junction where dilation and effacement initiate."
      },
      {
        "id": "presenting",
        "x": "50%",
        "y": "36%",
        "labelTr": "Önde Gelen Kısım (Baş)",
        "labelEn": "Presenting Fetal Part",
        "descTr": "Açılmayı tetiklemek üzere servikse baskı yapan baş küresi.",
        "descEn": "Direct hydrostatic pressure applied by fetal head onto cervix."
      }
    ]
  },
  "40": {
    ...
    "markers": [
      {
        ...
        "x": "45%",
        "y": "48%",
        "labelTr": "Fetal Fleksiyon Tonusu",
        "labelEn": "Fetal Flexion Tone",
        "descTr": "Kollar ve bacakların göğse doğru sımsıkı toplanmış güçlü kas tonusu.",
        "descEn": "Vigorous active flexion of limbs reflecting healthy central nervous system."
      },
      {
        "id": "vernix",
        "x": "58%",
        "y": "38%",
        "labelTr": "Verniks Partikülleri",
        "labelEn": "Vernix Flakes in Fluid",
        "descTr": "Bebeğin cildini koruyan kremsi tabakanın sıvı içinde uçuşan parlak pulları.",
        "descEn": "Echogenic floating vernix caseosa flakes confirming full-term skin maturity."
      }
    ]
  }
};
