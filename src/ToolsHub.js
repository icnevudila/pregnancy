...
export function getAllTools(lang = 'tr') {
  ...
  return [
    ...
    },
    {
      ...
      cat: 'medical',
      catTitle: isEn ? 'Growth & Tests' : 'Gelişim & Takip',
      title: isEn ? 'Size Comparison Guide' : 'Boyut Kıyaslama Rehberi',
      subtitle: isEn ? 'Fruit, animal, sweet & 3D fetus scale' : 'Meyve, hayvan, tatlı ve 3D fetüs ölçeği',
      icon: 'melon',
      art: 'sweet_macaron',
      color: '#F6F9F5',
      tint: '#5A8A62',
    ...
    },
    {
      ...
      cat: 'medical',
      catTitle: isEn ? 'Growth & Tests' : 'Gelişim & Takip',
      title: isEn ? 'Doctor Visit Dossier' : 'Doktor Muayene Raporu',
      subtitle: isEn ? 'Aggregated clinical vitals, questions & WhatsApp share' : 'Klinik kontrol için tekme, kilo, tansiyon ve soru özeti',
      icon: 'book',
    ...
    },
    {
      ...
      cat: 'medical',
      catTitle: isEn ? 'Growth & Tests' : 'Gelişim & Takip',
      title: isEn ? 'Blood Glucose & Diabetes' : 'Kan Şekeri & Diyabet',
      subtitle: isEn ? 'Fasting/postprandial target logs & OGTT guide' : 'Açlık/tokluk şeker takibi ve OGTT yükleme rehberi',
      icon: 'heart',
      art: 'card_blood_glucose',
      color: '#FAF5FF',
      tint: '#7C3AED',
      available: true,
    },
    ...
    },
    {
      ...
      title: isEn ? 'Story & Milestone Studio' : 'Hikaye & Paylaşım Stüdyosu',
      subtitle: isEn ? '9:16 Instagram & WhatsApp weekly baby size cards' : '9:16 Instagram & WhatsApp haftalık boyut ve an kartları',
      icon: 'sparkles',
    ...
    },
    {
      ...
      subtitle: isEn ? 'Kegel biofeedback coach & 34+ wk perineal tear prevention' : 'Ritmik Kegel koçu ve 34+ hafta doğum yırtığı önleme rehberi',
      icon: 'heart',
    ...
    },
    {
      ...
      cat: 'postpartum',
      catTitle: isEn ? 'Baby & Postpartum' : 'Bebek & Lohusalık',
      title: isEn ? 'Baby Vaccine Calendar (0-24m)' : 'Aşı & Bağışıklık Takvimi',
      subtitle: isEn ? 'Ministry schedule, fever care & completion tracking' : '0-24 ay aşı takvimi, ateş yönetimi & klinik notlar',
      icon: 'shield',
    ...
    },
    {
      ...
      cat: 'postpartum',
      catTitle: isEn ? 'Baby & Postpartum' : 'Bebek & Lohusalık',
      title: isEn ? 'Baby Teething & Fever' : 'Diş Çıkarma Haritası & Ateş',
      subtitle: isEn ? 'Interactive 20-tooth pediatric map & soothing tips' : '20 süt dişi anatomik haritası ve rahatlatma rehberi',
      icon: 'heart',
      art: 'card_baby_teething',
      color: '#F5FCF8',
      tint: '#059669',
      available: true,
    },
    {
      ...
      subtitle: isEn ? 'Age-indexed wake windows to prevent overtiredness' : 'Uyanıklık süreleri ve ideal uykuya geçiş tahmini',
      icon: 'moon',
      art: 'card_sleep_window',
      color: '#FAF5FF',
      tint: '#6D28D9',
      available: true,
    },
    {
      ...
      cat: 'postpartum',
      catTitle: isEn ? 'Baby & Postpartum' : 'Bebek & Lohusalık',
      title: isEn ? 'Wonder Weeks & Mental Leaps' : 'Harika Haftalar & Atak Takvimi',
      subtitle: isEn ? '10 developmental leaps, stormy days & new skills' : '10 zihinsel sıçrama, fırtınalı günler ve yeni beceriler',
      icon: 'milestone',
      art: 'card_wonder_leaps',
      color: '#FBF5FF',
      tint: '#7E22CE',
      available: true,
    },
    {
      ...
      cat: 'postpartum',
      catTitle: isEn ? 'Baby & Postpartum' : 'Bebek & Lohusalık',
      title: isEn ? 'BLW & 100 First Foods' : 'BLW & 100 İlk Besin Takibi',
      subtitle: isEn ? '3-day allergy rule, 100 foods & choking safety' : '3 gün alerji kuralı, 100 besin ve boğulma ilk yardımı',
      icon: 'leaf',
      art: 'card_solid_foods',
      color: '#F0FDF4',
      tint: '#15803D',
      available: true,
    },
    {
      ...
      cat: 'postpartum',
      catTitle: isEn ? 'Baby & Postpartum' : 'Bebek & Lohusalık',
      title: isEn ? 'WHO Growth & Percentiles' : 'Bebek Büyüme & Persentil',
      subtitle: isEn ? 'WHO biometric curves for weight, length & head circ' : 'DSÖ standartlarında kilo, boy ve baş çevresi eğrileri',
      icon: 'scale',
    ...
    },
    {
      ...
      cat: 'postpartum',
      catTitle: isEn ? 'Baby & Postpartum' : 'Bebek & Lohusalık',
      title: isEn ? 'CDC Milestones & Tummy Time' : 'Gelişim Basamakları & Tummy Time',
      subtitle: isEn ? 'AAP / CDC 2022 skills, red flags & tummy time coach' : 'Amerikan Pediatri Akademisi gelişim basamakları ve karın üstü koçu',
      icon: 'milestone',
